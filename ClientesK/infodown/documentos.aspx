                        ...
                        >
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <asp:Label ID="iIdInfoKiosko" runat="server" Text='<%# Bind("Cantidad") %>' Visible="false" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Archivo">
                                    <ItemTemplate>
                                        <asp:Label Width="100px" style=" text-align:Left;" ID="nombrearchivo" runat="server" Text='<%# Bind("nombrearchivo") %>'  Visible="true" ></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
