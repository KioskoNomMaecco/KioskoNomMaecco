...
public partial class imss_documentos : System.Web.UI.Page
{
    ...
    private void cargar_grid()
    {
        ...
        try
        {
            Tabla tbEmpresas = Manejador.getEjecutaStoredProcedure1("getDocImssMesAno_KC", Session["idusuario"].ToString() + "|" + cboempresas.SelectedValue + "|" + (cbomes.SelectedIndex + 1) + "|" + cboanio.Text);
            if (tbEmpresas != null)
            {
